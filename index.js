...
document.getElementById("title").innerHTML = DATASETS.TITLE;
document.getElementById("description").innerHTML = DATASETS.DESCRIPTION;
...
d3.json(DATASETS.FILE_PATH, function(error,data){
